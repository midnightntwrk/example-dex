...
class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      padTokenAmount(context, ...args_1) {
        return { result: pureCircuits.padTokenAmount(...args_1), context };
      },
      claim: (...args_1) => {
        if (args_1.length !== 2) {
  ...
  initialState(...args_0) {
    ...
    if (!(typeof(fixedSupply_0) === 'bigint' && fixedSupply_0 >= 0n && fixedSupply_0 <= 340282366920938463463374607431768211455n)) {
      __compactRuntime.type_error('Contract state constructor',
    ...
    this.__mint_0(context,
                  partialProofData,
                  this._right_0(_descriptor_1.fromValue(Contract._query(context,
                                                                        partialProofData,
                                                                        [
                                                                         { dup: { n: 2 } },
                                                                         { idx: { cached: true,
                  ...
                  this._right_0(_descriptor_1.fromValue(Contract._query(context,
                                                                        ...
                                                                        [
                                                                         ...
                                                                         { popeq: { cached: true,
                                                                                    result: undefined } }]).value)),
                  fixedSupply_0);
    const tmp_1 = this._padTokenAmount_0(100n);
    Contract._query(context,
                    partialProofData,
                    [
                     { push: { storage: false,
  ...
  _addLiquidity_0(context, partialProofData, token_0, amount_0) {
    ...
    if ($token_0 === 0) {
      ...
      const success_0 = this._transfer_0(context,
                                         partialProofData,
                                         this._right_0(contractAddress_0),
                                         amount_0);
      __compactRuntime.assert(success_0, 'Failed to transfer Foo tokens');
                                                              ...
                                                              result: undefined } }]).value))
      {
        const currentLiquidity_0 = _descriptor_8.fromValue(Contract._query(context,
                                                                           ...
                                                                           [
                                                                            ...
                                                                            { popeq: { cached: false,
                                                                                       result: undefined } }]).value);
        const tmp_0 = this._safeAdd_0(currentLiquidity_0, $amount_0);
        Contract._query(context,
                        partialProofData,
                        [
                         { idx: { cached: false,
                                                              ...
                                                              result: undefined } }]).value))
      {
        const currentLiquidity_1 = _descriptor_8.fromValue(Contract._query(context,
                                                                           ...
                                                                           [
                                                                            ...
                                                                            { popeq: { cached: false,
                                                                                       result: undefined } }]).value);
        const tmp_1 = this._safeAdd_0(currentLiquidity_1, $amount_0);
        Contract._query(context,
                        partialProofData,
                        [
                         { idx: { cached: false,
  ...
  _swap_0(context, partialProofData, from_0) {
    ...
    const barPool_0 = this._balanceOf_0(context,
                                        ...
                                        this._right_0(contractAddress_0));
    if ($from_0 === 0) {
      __compactRuntime.assert(barPool_0 >= amountToBuy_0,
                              'Not enough Bar tokens in the pool');
      ...
      __compactRuntime.assert(fooPool_0 >= amountToBuy_0,
                              'Not enough Foo tokens in the pool');
      this._transferFrom_0(context,
                           partialProofData,
                           this._right_0(contractAddress_0),
                           this._left_0(this._ownPublicKey_0(context,
...
const pureCircuits = {
  padTokenAmount: (...args_0) => {
    if (args_0.length !== 1) {
      throw new __compactRuntime.CompactError(`padTokenAmount: expected 1 argument (as invoked from Typescript), received ${args_0.length}`);
    }
    const amount_0 = args_0[0];
    if (!(typeof(amount_0) === 'bigint' && amount_0 >= 0n && amount_0 <= 340282366920938463463374607431768211455n)) {
      __compactRuntime.type_error('padTokenAmount',
                                  'argument 1',
                                  'contract.compact line 20 char 1',
                                  'Uint<0..340282366920938463463374607431768211455>',
                                  amount_0)
    }
    return _dummyContract._padTokenAmount_0(amount_0);
  }
};
